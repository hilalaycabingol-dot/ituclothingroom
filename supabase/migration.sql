...
-- 3. RESERVATIONS TABLE (includes PICKED_UP status)
CREATE TABLE IF NOT EXISTS reservations (
  ...
  status TEXT NOT NULL CHECK (status IN ('PENDING', 'APPROVED', 'REJECTED', 'PICKED_UP')) DEFAULT 'PENDING',
  created_at TIMESTAMPTZ DEFAULT NOW()
);
...
-- ============================================================
-- MIGRATION: If tables already exist, run this ALTER instead:
